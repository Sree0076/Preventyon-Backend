...
namespace PreventyonUnitTest
{
    ...
    public class EmployeeControllerUnitTest
    {
        ...
        public void Setup()
        {
            ...
            _controller = new EmployeeController(_employeeServiceMock.Object, _context, Mock.Of<ILogger<EmployeeController>>());
        }
        ...
        public async Task PostEmployee_ValidEmployee_ReturnsOk()
        {
            ...
            _employeeServiceMock.Setup(s => s.AddEmployee(It.IsAny<CreateEmployeeDTO>())).ReturnsAsync(createdEmployee);
        ...
        public async Task GetEmployees_ReturnsOkWithEmployees()
        {
            ...
            _employeeServiceMock.Setup(s => s.GetEmployees()).ReturnsAsync(employees);
        ...
        public async Task GetEmployeeByIdAsync_ValidId_ReturnsOkWithEmployee()
        {
            ...
            _employeeServiceMock.Setup(s => s.GetEmployeeByIdAsync(employeeId)).ReturnsAsync(employee);
        ...
        public async Task GetEmployeeByTokenAsync_ValidToken_ReturnsOkWithEmployee()
        {
            ...
            var employee = new GetEmployeeRoleWithIDDTO { Id = 1, Name = "John Doe", Email = "john.doe@example.com", Department = "IT", Designation = "Developer", Role = new RoleDTO { Id = 1, Name = "Admin" } };
            _employeeServiceMock.Setup(s => s.GetEmployeeByTokenAsync(It.IsAny<string>(), It.IsAny<ApiContext>())).ReturnsAsync(employee);
        ...
        public async Task PostEmployee_IncompleteDTO_ReturnsBadRequest()
        {
            ...
            _employeeServiceMock.Setup(s => s.AddEmployee(It.IsAny<CreateEmployeeDTO>())).ThrowsAsync(new ArgumentException("Invalid data"));
        ...
        public async Task PostEmployee_InvalidRoleId_ReturnsBadRequest()
        {
            ...
            _employeeServiceMock.Setup(s => s.AddEmployee(It.IsAny<CreateEmployeeDTO>())).ThrowsAsync(new ArgumentException("Invalid RoleId"));
            ...
            Assert.IsNotNull(result);
            Assert.AreEqual(StatusCodes.Status400BadRequest, result.StatusCode);
            Assert.AreEqual("Invalid RoleId", result.Value);
        }
        ...
        {
            // Arrange
            _employeeServiceMock.Setup(s => s.GetEmployees()).ThrowsAsync(new Exception("Service error"));
        ...
        public async Task GetEmployeeByIdAsync_ServiceThrowsException_ReturnsBadRequest()
        {
            // Arrange
            var employeeId = 1;
            _employeeServiceMock.Setup(s => s.GetEmployeeByIdAsync(employeeId)).ThrowsAsync(new Exception("Service error"));
